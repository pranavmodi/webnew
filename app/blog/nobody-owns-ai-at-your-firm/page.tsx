    ...
    <div className="bg-black pb-24">
      ...
      <article className="mx-auto max-w-4xl space-y-12 px-4 pt-12 text-foreground/85 sm:px-6">
        <section className="space-y-4">
          ...
          <p>
            <a href="https://smbteam.com/" target="_blank" rel="noopener noreferrer" className="text-[#00ff41] hover:underline">Andy Stickel</a>, who has worked with over 176 law firms on growth strategy, puts it bluntly: the number one mistake law firm owners make when implementing AI is not having someone who owns it. &quot;As soon as someone owned it, results picked up 10x faster,&quot; he says. &quot;This saved us thousands of hours &mdash; thousands of hours of research, thousands of hours of testing different vendors, hours of team interviews and workflow analysis.&quot;
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            Now look at <a href="https://mccreadylaw.com/meet-our-team/michael-mccready/" target="_blank" rel="noopener noreferrer" className="text-[#00ff41] hover:underline">Michael McCready</a>&apos;s firm, McCready Law. McCready runs a 100-person PI operation across six offices in the Midwest. His caseload doubled in 18 months. His marketing spend sits at 7.5% of revenue &mdash; compared to the 25&ndash;35% that most PI firms hemorrhage on advertising. The difference isn&apos;t budget or sophistication. It&apos;s that someone obsessively owns the technology strategy.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            <a href="https://trainual.com/about" target="_blank" rel="noopener noreferrer" className="text-[#00ff41] hover:underline">Chris Ronzio</a>, CEO of Trainual and an expert in operational systems, makes the distinction that most firms miss: &quot;There&apos;s the how-to&apos;s and there&apos;s the to-do&apos;s. Your to-do&apos;s happen in Salesforce or Filevine. But the how-to&apos;s happen in your training platform.&quot; AI sits on top of both &mdash; but only if the foundation exists.
          </p>
          <p>
