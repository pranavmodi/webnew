          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-base text-foreground/80">
                Learn how a California medical imaging chain used our AI Support Agent alongside email
                automation to cut support workload by 62% and boost patient satisfaction by 41%.
              </p>
            </div>
